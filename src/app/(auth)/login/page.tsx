...
import { getAuth, signInWithEmailAndPassword, signInAnonymously, GoogleAuthProvider, signInWithPopup } from 'firebase/auth';
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <Button variant="link" className="w-full mt-2" onClick={handleAnonymousSignIn} disabled={isLoading}>
                Continue as Guest
            </Button>
          </div>
